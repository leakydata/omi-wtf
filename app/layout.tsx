...
const description = "Omi pages advertised $199 per year and 1,200 free minutes. See the receipts and the risk of letting a hardware company control the price of a growing memory archive.";
